  ...
  productCardsList.innerHTML = `
    <section class="about">
      <div class="about__img-wrap">
        <img class="about__img" src="img/fon-about.webp" alt="о нас">
      </div>
      <div class="about__info">
        <p>
          Мы — команда увлечённых рыболовов, для которых рыбалка — не просто хобби, а образ жизни.
          ...
          профессионал найдёт всё необходимое для удачного улова.
        </p>
        <p>
          Наша цель — сделать рыбалку доступной, комфортной и по-настоящему вдохновляющей.
          Мы тщательно подбираем ассортимент, тестируем снасти и оборудование, чтобы предложить
          вам только проверенные товары, которым можно доверять в любых условиях.
        </p>
        <p>
          С нами вы всегда будете готовы к новым рыболовным приключениям, будь то утренний клёв на озере
          или охота за трофейной щукой на реке.
        </p>
